...
public class LifeCycleDemoBean implements InitializingBean, DisposableBean, BeanNameAware, BeanFactoryAware, ApplicationContextAware {
    ...
    public void beforeInit() {
        System.out.println("## The Before init method being called from the Custom Bean Post Processor");
    }

    public void afterInit() {
        System.out.println("## The After init method being called from the Custom Bean Post Processor");
    }
}
